...
public:
	 ...
	 *         space.
	 */
	DEPRECATED(4.20, "There is no need to use this function since it always returns (0,0,0).")
	 ...
	 *         space.
	 */
	DEPRECATED(4.20, "Please use UARTrackedImage::GetEstimatedSize() instead.")
	UFUNCTION(BlueprintPure, Category = "GoogleARCore|AugmentedImage", meta = (Keywords = "googlear arcore augmentedimage"))
	 ...
	 */
	DEPRECATED(4.20, "Instead of getting the index, you can use UARTrackedImage::GetDetectedImage() to get the UARCandidateImage object.")
	UFUNCTION(BlueprintPure, Category = "GoogleARCore|AugmentedImage", meta = (Keywords = "googlear arcore augmentedimage"))
	 ...
	 */
	DEPRECATED(4.20, "Please use UARCandidateImage::GetFriendlyName() instead.")
	UFUNCTION(BlueprintPure, Category = "GoogleARCore|AugmentedImage", meta = (Keywords = "googlear arcore augmentedimage"))
